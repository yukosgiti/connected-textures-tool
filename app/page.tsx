...
const NODE_TYPE_ICONS: Record<AppNodeType, typeof Image01FreeIcons> = {
  ...
  swirlTexture: Rotate360FreeIcons,
  skewTexture: Rotate360FreeIcons,
  flipTexture: Rotate360FreeIcons,
  translateTexture: Image01FreeIcons,
  scaleTexture: Image01FreeIcons,
  magnifyTexture: Image01FreeIcons,
  cropTexture: Image01FreeIcons,
  tileTexture: Image01FreeIcons,
  blurTexture: Image01FreeIcons,
  contrastTexture: Image01FreeIcons,
  thresholdTexture: Image01FreeIcons,
  brightnessTexture: Image01FreeIcons,
  levelsTexture: Image01FreeIcons,
  grayscaleTexture: Image01FreeIcons,
  ...
  pingPongTexture: Image01FreeIcons,
  trimTexture: Image01FreeIcons,
  frameBlendTexture: Image01FreeIcons,
  ...
  channelSplitTexture: Image01FreeIcons,
  channelCombineTexture: Image01FreeIcons,
  preview: ViewIcon,
